				...
				<div class="tabs">
					...
					<div class="tab-left">
						<ul class="resp-tabs-list">
							...
							<li class="resp-tab-item"><i class="fa fa-car" aria-hidden="true"></i>Add Rewards</li>
					...
					<div class="tab-right">
						<div class="resp-tabs-container">
							...
							<?php 
									include 'qrscanner/qr_redeem.php';
								?>
							
								<div class="redeemReward">
									<p>Customer have 100 Reward pointssss.</p><br>
									<form action="#" method="post" class="agile_form">
